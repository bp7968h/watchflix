...
const GptSearchBar = () => {
    ...
    return (
        <form onSubmit={(e) => e.preventDefault()} style={{
            ...
            <button onClick={handleButtonClick} style={{ border: 'none', width: '125px', padding: '20px', borderRadius: '15px', background: 'rgb(229, 9, 20)', color: 'white', cursor: 'pointer', fontWeight: 'bold' }}>Search</button>
        </form>
    )
}
